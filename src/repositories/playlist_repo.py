...
class PlaylistRepository:
    ...
    def insert(self, playlist: Playlist) -> Playlist:
        ...
        result = conn.execute(
            """
            INSERT INTO playlists (name, book, chapter_start, verse_start, chapter_end, verse_end, youtube_playlist_id)
            VALUES (?, ?, ?, ?, ?, ?, ?)
            RETURNING id
            """,
            [
    ...
    def update(self, playlist: Playlist) -> None:
        ...
        conn.execute(
            """
            UPDATE playlists
            SET name = ?, book = ?, chapter_start = ?, verse_start = ?,

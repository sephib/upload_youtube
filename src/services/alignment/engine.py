...
class AlignmentEngine:
    ...
    def align(
        ...
        Returns:
            AlignmentRun with verse timestamps
        ...
        alignment_run = AlignmentRun(
            ...
            timestamps_json=AlignmentRun.encode_timestamps(verse_timestamps),
    ...
    def save_alignment_run(self, alignment_run: AlignmentRun, output_path: Path) -> None:
        """Save alignment run to JSON file.

        Args:
            alignment_run: AlignmentRun to save
            output_path: Output file path
        """
        output_path.parent.mkdir(parents=True, exist_ok=True)

        data = alignment_run.model_dump(mode="json")

        with output_path.open("w", encoding="utf-8") as f:
            json.dump(data, f, ensure_ascii=False, indent=2)

        logger.info(f"Saved alignment run", output_path=str(output_path))
